...
SPECS = [
    ...
    },
    {
        ...
        "function": {
            "name": "chamfer_edges",
            "description": "Cut a flat chamfer on the edges the user has clicked.",
            "parameters": {
                "type": "object",
                "properties": {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "thread": {
                        "type": "string",
                        "description": "Metric size such as M3, M4. Sets a clearance diameter, or a tapped hole if threaded is true.",
                    },
                    ...
                    "head": {
                        ...
                        "description": "Head recess. Default none.",
                    },
                    "positions": {
                        "type": "array",
                        "description": "Where to put them on the face, in mm. Defaults to one at the origin.",
                        "items": {
                            "type": "object",
                            "properties": {
                                "x": {"type": "number"},
